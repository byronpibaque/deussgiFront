  ...
  <v-layout align-start>
    <v-flex>
      <v-toolbar flat color="white" v-if="verNuevo == 0">
        <v-toolbar-title>Diarios</v-toolbar-title>
      ...
      <v-container grid-list-sm class="pa-4 white" v-if="verNuevo">
        ...
        <v-layout row wrap>
          ...
          <v-flex xs12 sm12 md12 lg12 xl12>
            ...
            <v-flex class="text-xs-right">
                <span style="font-size: 20px" class="green--text">
                  TOTAL:
                </span>
                <span style="font-size: 20px">
                 $ {{ (totalglobal = calcularTotalGlobal) }}
                </span>
    ...
    calcularTotalGlobal: function() {
      let total = 0.0
       for (var i = 0; i < this.detalles.length; i++) {
        total = parseFloat(total) + parseFloat(this.detalles[i].valor);
      }
      total+=parseFloat(this.ofrenda)+parseFloat(this.ofrendaEspecial)+parseFloat(this.ofrendaPrimicia)+parseFloat(this.otrasOfrendas)
