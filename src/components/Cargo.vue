    ...
    export default {
        ...
        methods: {
            listar(){
                ...
                axios.get('cargo/list',configuracion).then(function (response){
            ...
            activar(){
                let me=this;
                axios.put('cargo/activate',{'_id':this.adId})
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
            ...
            desactivar(){
                let me=this;
                axios.put('cargo/deactivate',{'_id':this.adId})
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
